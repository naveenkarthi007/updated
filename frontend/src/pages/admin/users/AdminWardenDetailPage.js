        ...
        <>
          <div className="bg-gradient-to-br from-brand-primary to-brand-primary/70 rounded-2xl p-6 text-white shadow-lg">
            ...
            <p className="text-white/70 text-sm mt-1">
              {hostelStats.hostel.block_code ? `Block ${hostelStats.hostel.block_code}` : ''}
              {hostelStats.hostel.gender ? ` · ${hostelStats.hostel.gender === 'MALE' ? 'Boys Hostel' : hostelStats.hostel.gender === 'FEMALE' ? 'Girls Hostel' : 'Co-ed'}` : ''}
            </p>
          </div>
